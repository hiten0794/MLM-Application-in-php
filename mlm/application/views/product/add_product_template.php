      ...
      <div class="row" id="element_overlap">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
             <!-- form start -->
            <form role="form" id="ProductForm" action="<?=base_url('add_product');?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="Price" placeholder="Product">
                  <p class="help-block"></p>
                </div> 
                ...
                <div class="form-group">
                  ...
                  <input type="text" onChange="gst('gstError','sgst');" class="form-control" id="sgst" >
                  <p class="help-block" id="gstError"></p>
                </div>
                
                  <div class="form-group">
                  <label for="exampleInputPassword1">CGST</label>
                  <input type="text"  onChange="gst('cgstError','cgst');" class="form-control" id="cgst">
                  <p class="help-block" id="cgstError"></p>
                </div>
                
                  <div class="form-group">
                  <label for="exampleInputPassword1">IGST</label>
                  <input type="text" onChange="gst('igstError','igst');" class="form-control" id="igst">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="SalePrice" placeholder="Product">
                  <p class="help-block"></p>
                </div>
                
                <div class="form-group">
                  <label for="exampleInputPassword1">HSN</label>
                  <input type="text" class="form-control" id="hsn" placeholder="">
                  <p class="help-block"></p>
                </div>
                
                <div class="form-group"> 
                  <label for="exampleInputPassword1">SAC</label>
                  <input type="text" class="form-control" id="sac" placeholder="">
                  <p class="help-block"></p>
                </div>
