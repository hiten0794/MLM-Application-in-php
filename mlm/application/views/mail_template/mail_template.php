...
<div id="main" style="width:90%; height:725px; border:1px solid #CCC;">
  ...
  <div>
    ...
    <p style="margin-left: 35px;"><strong>Password :</strong> {templatePassword}</p>
    <br />
    ...
    <p style="margin-left: 35px;">MLM Pvt. Ltd.</p>
  </div>
  <div id="titllebar" style="width:100%; height:50px;background-color: aliceblue;">
    <div style="width:50%; float:left; color: #272020;font-size: 23px; margin-top: 12px; padding-left: 11px;">MLM Pvt. Ltd.</div>
